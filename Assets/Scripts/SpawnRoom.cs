...
GameObject shortwall2;
   ...
   // public GameObject previewmat;
    ...
    void Start()
    {
        ...
        longplin1 = Instantiate(plintus, transform.position + 
            new Vector3(-1.9f,0, -10 * width / 2), transform.rotation, transform);
        longplin1.transform.localScale = new Vector3(length*11, 2, 1);

        longplin2 = Instantiate(plintus, transform.position + 
            new Vector3(1.9f, 0, 10 * width / 2), transform.rotation * 
            Quaternion.Euler(0f, 180f, 0f), transform);
        longplin2.transform.localScale = new Vector3(length * 11, 2, 1);

        shortplin1 = Instantiate(plintus, transform.position + 
            new Vector3(10 * length / 2, 0, -0.9f), transform.rotation *
            Quaternion.Euler(0f, -90f, 0f), transform);
        shortplin1.transform.localScale = new Vector3(width* 11, 2, 1);

        shortplin2 = Instantiate(plintus, transform.position + 
            new Vector3(-10 * length / 2, 0, 0.9f), transform.rotation * 
            Quaternion.Euler(0f, 90f, 0f), transform);
        ...
        longwall2 = Instantiate(wallpref, transform.position + new Vector3(0, 10 * height / 2, -10 * width / 2), transform.rotation, transform);
        longwall2.transform.eulerAngles = new Vector3(-90f, -90, -90f);
        ...
        shortwall1.transform.localScale = new Vector3(length, 1, height);

        shortrend = shortwall1.GetComponent<Renderer>();
        shortrend.material.SetTextureScale("_MainTex", new Vector2(4, 3));
        ...
        shortwall2.transform.localScale = new Vector3(length, 1, height);
